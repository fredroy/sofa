...
template class SOFACUDA_COMPONENT_API BarycentricMapping< CudaVec3f1Types, CudaVec3fTypes>;
template class SOFACUDA_COMPONENT_API BarycentricMapping< CudaVec3fTypes, CudaVec3f1Types>;
