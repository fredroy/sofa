...
template<>
void BarycentricMapping<CudaVec3f1Types, CudaVec3f1Types>::applyJ(
...
template<>
void BarycentricMapping<CudaVec3f1Types, CudaVec3f1Types>::applyJT(
    const core::MechanicalParams* mparams,
...
// instantiations involving only CudaVec3f1Types with CudaVec3f1Types
...
void registerBarycentricMapping_3f1(sofa::core::ObjectFactory* factory)
{
    factory->registerObjects(sofa::core::ObjectRegistrationData("Supports GPU-side computations using CUDA for the BarycentricMapping_3f1")
