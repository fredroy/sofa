...
template class SOFACUDA_COMPONENT_API FixedTranslationProjectiveConstraint<gpu::cuda::CudaVec6fTypes>;
template class SOFACUDA_COMPONENT_API FixedTranslationProjectiveConstraint<gpu::cuda::CudaRigid3fTypes>;
#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API FixedTranslationProjectiveConstraint<gpu::cuda::CudaVec6dTypes>;
template class SOFACUDA_COMPONENT_API FixedTranslationProjectiveConstraint<gpu::cuda::CudaRigid3dTypes>;
#endif // SOFA_GPU_CUDA_DOUBLE
