...
void registerGeomagicEmulator(sofa::core::ObjectFactory* factory)
{
    factory->registerObjects(sofa::core::ObjectRegistrationData("Driver emulating a Geomagic haptic device.")
