...
//								std::vector< MechanicalState<sofa::defaulttype::Vec1dTypes>* >::iterator articulatedObjItEnd = articulatedObjects.end();
            ...
            static_cast<sofa::simulation::Node*>(this->getContext())->execute<sofa::simulation::mechanicalvisitor::MechanicalProjectPositionAndVelocityVisitor>(sofa::core::MechanicalParams::defaultInstance());
            static_cast<sofa::simulation::Node*>(this->getContext())->execute<sofa::simulation::mechanicalvisitor::MechanicalPropagateOnlyPositionAndVelocityVisitor>(sofa::core::MechanicalParams::defaultInstance());
