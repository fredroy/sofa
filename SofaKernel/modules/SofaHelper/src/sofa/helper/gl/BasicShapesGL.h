...
extern template class SOFA_HELPER_API BasicShapesGL_Sphere<std::array< float, 3 > >;
extern template class SOFA_HELPER_API BasicShapesGL_Sphere<std::array< double, 3 > >;
extern template class SOFA_HELPER_API BasicShapesGL_FakeSphere<std::array< float, 3 > >;
extern template class SOFA_HELPER_API BasicShapesGL_FakeSphere<std::array< double, 3 > >;
