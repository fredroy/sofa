...
public:
    ...
    typedef std::array<PointID, 4> HighOrderEdgePosition;
    ...
    typedef std::array<PointID, 5> HighOrderTrianglePosition;
    ...
    typedef std::array<PointID, 6> HighOrderQuadPosition;
    ...
    typedef std::array<PointID, 6> HighOrderTetrahedronPosition;
    ...
    typedef std::array<PointID, 8> HighOrderHexahedronPosition;
