...
void VoxelLoader::addHexahedron(helper::vector< Hexahedron >* pHexahedra,
...
{
    addHexahedron(pHexahedra, std::array <unsigned int, 8>{p0, p1, p2, p3, p4, p5, p6, p7});
}

void VoxelLoader::addHexahedron(helper::vector< Hexahedron >* pHexahedra, const std::array<unsigned int,8> &p)
{
