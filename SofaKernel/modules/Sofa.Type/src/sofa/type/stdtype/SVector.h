...
//======================================================================
template< class T >
class SVector: public sofa::type::stdtype::vector<T, CPUMemoryManager<T> >
{
public:
    using Inherit = sofa::type::stdtype::vector<T, CPUMemoryManager<T> >;
    typedef CPUMemoryManager<T>  Alloc;
    /// Size
