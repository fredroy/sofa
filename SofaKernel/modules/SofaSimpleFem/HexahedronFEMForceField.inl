...
template<class DataTypes>
void HexahedronFEMForceField<DataTypes>::computeElementStiffness( ElementStiffness &K, const MaterialStiffness &M, const std::array<Coord,8> &nodes, const int elementIndice, double stiffnessFactor)
{
