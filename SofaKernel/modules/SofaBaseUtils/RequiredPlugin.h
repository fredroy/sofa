...
public:
    ...
    sofa::core::objectmodel::Data<helper::vector<std::array<std::string,2> > > d_suffixMap; ///< standard->custom suffixes pairs (to be used if the plugin is compiled outside of Sofa with a non standard way of differenciating versions), using ! to represent empty suffix
