...
public:
    ...
    virtual void computeElementMass( ElementMass &Mass, const std::array<Coord,8> &nodes, const int elementIndice, SReal stiffnessFactor=1.0); ///< compute the mass matrix of an element
