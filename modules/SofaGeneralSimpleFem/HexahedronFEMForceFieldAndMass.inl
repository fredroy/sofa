...
template<class DataTypes>
void HexahedronFEMForceFieldAndMass<DataTypes>::computeElementMass( ElementMass &Mass, const std::array<Coord,8> &nodes, const int /*elementIndice*/, SReal stiffnessFactor)
{
