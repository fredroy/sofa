...
void HexahedralFEMForceField<DataTypes>::draw(const core::visual::VisualParams* vparams)
{
    ...
    for(size_t i = 0 ; i<_topology->getNbHexahedra(); ++i)
    {
        ...
        std::array<float, 4> color = std::array<float, 4>{ 0.7f, 0.7f, 0.1f, 1.0f };
        ...
        color = std::array<float, 4>{ 0.7f, 0.0f, 0.0f, 1.0f };
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        ...
        color = std::array<float, 4>{ 0.0f, 0.7f, 0.0f, 1.0f };
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        ...
        color = std::array<float, 4>{ 0.0f, 0.0f, 0.7f, 1.0f };
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        ...
        color = std::array<float, 4>{ 0.1f, 0.7f, 0.7f, 1.0f };
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        ...
        color = std::array<float, 4>{ 0.7f, 0.1f, 0.7f, 1.0f };
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
        colorVector.push_back(sofa::defaulttype::RGBAColor(color));
