...
extern template class SOFA_GENERAL_ENGINE_API MapIndices< std::array<unsigned int, 2> >;
extern template class SOFA_GENERAL_ENGINE_API MapIndices< std::array<unsigned int, 3> >;
extern template class SOFA_GENERAL_ENGINE_API MapIndices< std::array<unsigned int, 4> >;
extern template class SOFA_GENERAL_ENGINE_API MapIndices< std::array<unsigned int, 8> >;
#endif
