...
template<class DataTypes>
void UncoupledConstraintCorrection<DataTypes>::resetForUnbuiltResolution(SReal * f, sofa::core::behavior::BaseConstraintCorrection::ConstraintSequence& /*renumbering*/)
{
    const MatrixDeriv& constraints = this->mstate->read(core::vec_id::read_access::constraintJacobian)->getValue();
