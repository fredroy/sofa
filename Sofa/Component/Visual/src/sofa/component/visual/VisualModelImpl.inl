...
void TVisualModelImpl<DataTypes>::parse(core::objectmodel::BaseObjectDescription* arg)
{
    this->core::visual::VisualModel::parse(arg);

    TVisualModelImpl* obj = this;
...
template< typename DataTypes >
TVisualModelImpl<DataTypes>::TVisualModelImpl() //const std::string &name, std::string filename, std::string loader, std::string textureName)
    :  useTopology(false)
    , lastMeshRev(-1)
    , castShadow(true)
...
template< typename DataTypes >
TVisualModelImpl<DataTypes>::~TVisualModelImpl()
{
}

template< typename DataTypes >
bool TVisualModelImpl<DataTypes>::hasTransparent()
{
...
template< typename DataTypes >
bool TVisualModelImpl<DataTypes>::hasOpaque()
{
    const Material& material = this->material.getValue();
    helper::ReadAccessor< Data< type::vector<FaceGroup> > > groups = this->groups;
    helper::ReadAccessor< Data< type::vector<Material> > > materials = this->materials;
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::drawVisual(const core::visual::VisualParams* vparams)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::drawTransparent(const core::visual::VisualParams* vparams)
{
    if (hasTransparent())
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::drawShadow(const core::visual::VisualParams* vparams)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::setMesh(helper::io::Mesh &objLoader, bool tex)
{
...
template< typename DataTypes >
bool TVisualModelImpl<DataTypes>::load(const std::string& filename, const std::string& loader, const std::string& textureName)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::applyUVTransformation()
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::applyTranslation(const SReal dx, const SReal dy, const SReal dz)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::applyRotation(const SReal rx, const SReal ry, const SReal rz)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::applyRotation(const Quat<SReal> q)
{
    Data< VecCoord >* d_x = this->write(core::VecCoordId::position());
    VecCoord &x = *d_x->beginEdit();
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::applyScale(const SReal sx, const SReal sy, const SReal sz)
{
    Data< VecCoord >* d_x = this->write(core::VecCoordId::position());
    VecCoord &x = *d_x->beginEdit();
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::applyUVTranslation(const Real dU, const Real dV)
{
    float dUf = float(dU);
    float dVf = float(dV);
    VecTexCoord& vtexcoords = *(m_vtexcoords.beginEdit());
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::applyUVScale(const Real scaleU, const Real scaleV)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::init()
{
    VisualModel::init();
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::initPositionFromVertices()
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::initFromFileMesh()
{
    load(fileMesh.getFullPath(), "", texturename.getFullPath());
}

template< typename DataTypes >
void TVisualModelImpl<DataTypes>::initFromTopology()
{
    if (l_topology.empty())
    {
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::computeNormals()
{
...
template< typename DataTypes >
auto TVisualModelImpl<DataTypes>::computeTangent(const Coord &v1, const Coord &v2, const Coord &v3,
                                                       const TexCoord &t1, const TexCoord &t2, const TexCoord &t3) -> Coord
{
...
template< typename DataTypes >
auto TVisualModelImpl<DataTypes>::computeBitangent(const Coord &v1, const Coord &v2, const Coord &v3,
                                                         const TexCoord &t1, const TexCoord &t2, const TexCoord &t3) -> TVisualModelImpl<DataTypes>::Coord
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::computeTangents()
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::computeBBox(const core::ExecParams*, bool)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::computeUVSphereProjection()
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::flipFaces()
{
    VecDeriv& vnormals = *(m_vnormals.beginEdit());
    VecVisualEdge& edges = *(m_edges.beginEdit());
    VecVisualTriangle& triangles = *(m_triangles.beginEdit());
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::setColor(float r, float g, float b, float a)
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::setColor(std::string color)
{
    if (color.empty())
        return;
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::updateVisual()
{
    if (modified && !getVertices().empty())
    {
        ...
        sofa::helper::AdvancedTimer::stepBegin("TVisualModelImpl<DataTypes>::computePositions");
        computePositions();
        sofa::helper::AdvancedTimer::stepEnd("TVisualModelImpl<DataTypes>::computePositions");

        sofa::helper::AdvancedTimer::stepBegin("TVisualModelImpl<DataTypes>::updateBuffers");
        updateBuffers();
        sofa::helper::AdvancedTimer::stepEnd("TVisualModelImpl<DataTypes>::updateBuffers");

        sofa::helper::AdvancedTimer::stepBegin("TVisualModelImpl<DataTypes>::computeNormals");
        computeNormals();
        sofa::helper::AdvancedTimer::stepEnd("TVisualModelImpl<DataTypes>::computeNormals");

        if (m_updateTangents.getValue())
        {
            sofa::helper::AdvancedTimer::stepBegin("TVisualModelImpl<DataTypes>::computeTangents");
            computeTangents();
            sofa::helper::AdvancedTimer::stepEnd("TVisualModelImpl<DataTypes>::computeTangents");
        }
        modified = false;
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::computePositions()
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::computeMesh()
{
...
template< typename DataTypes >
void TVisualModelImpl<DataTypes>::exportOBJ(std::string name, std::ostream* out, std::ostream* mtl, sofa::Index& vindex, sofa::Index& nindex, sofa::Index& tindex, int& count)
{
    *out << "g "<<name<<"\n";
