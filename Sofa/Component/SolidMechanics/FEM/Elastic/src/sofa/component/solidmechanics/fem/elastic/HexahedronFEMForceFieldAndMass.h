...
public:
    ...
    virtual void computeElementMass( ElementMass &Mass, const type::Vec<8,Coord> &nodes, const Index elementIndice, SReal stiffnessFactor=1.0); ///< compute the mass matrix of an element
