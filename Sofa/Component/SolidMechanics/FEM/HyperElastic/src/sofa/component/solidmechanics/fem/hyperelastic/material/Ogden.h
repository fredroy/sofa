...
public:
    ...
    void ElasticityTensor(StrainInformation<DataTypes> *sinfo, const MaterialParameters<DataTypes> &param, Matrix6& outputTensor) override
    {
        ...
        trCalpha_HC_.col(0)=Calpha_1[0]*CC;
        trCalpha_HC_.col(1)=Calpha_1[1]*CC;
        trCalpha_HC_.col(2)=Calpha_1[2]*CC;
        trCalpha_HC_.col(3)=Calpha_1[3]*CC;
        trCalpha_HC_.col(4)=Calpha_1[4]*CC;
        trCalpha_HC_.col(5)=Calpha_1[5]*CC;
        MatrixSym CCalpha_1;
        CCalpha_1=Calpha_1;
        CCalpha_1[1]+=Calpha_1[1]; CCalpha_1[3]+=Calpha_1[3]; CCalpha_1[4]+=Calpha_1[4];
        Matrix6 trC_HCalpha;
        trC_HCalpha.col(0)=_C[0]*CCalpha_1;
        trC_HCalpha.col(1)=_C[1]*CCalpha_1;
        trC_HCalpha.col(2)=_C[2]*CCalpha_1;
        trC_HCalpha.col(3)=_C[3]*CCalpha_1;
        trC_HCalpha.col(4)=_C[4]*CCalpha_1;
        trC_HCalpha.col(5)=_C[5]*CCalpha_1;
