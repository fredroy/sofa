...
public:
  ...
  public:
	...
	virtual void ElasticityTensor(StrainInformation<DataTypes> *sinfo, const MaterialParameters<DataTypes> &param,Matrix6 &outputTensor)  {
		...
		Matrix6 trUE_HC_;
        trUE_HC_.col(0)=UE[0]*CC;
        trUE_HC_.col(1)=UE[1]*CC;
        trUE_HC_.col(2)=UE[2]*CC;
        trUE_HC_.col(3)=UE[3]*CC;
        trUE_HC_.col(4)=UE[4]*CC;
        trUE_HC_.col(5)=UE[5]*CC;
		Matrix6 trC_HUE_;
		MatrixSym UUE;
		UUE=UE;
		UUE[1]+=UE[1];UUE[3]+=UE[3];UUE[4]+=UE[4];
        trC_HUE_.col(0)=_C[0]*UUE;
        trC_HUE_.col(1)=_C[1]*UUE;
        trC_HUE_.col(2)=_C[2]*UUE;
        trC_HUE_.col(3)=_C[3]*UUE;
        trC_HUE_.col(4)=_C[4]*UUE;
        trC_HUE_.col(5)=_C[5]*UUE;

		Matrix6 trUEHUE;
        trUEHUE.col(0)=UE[0]*UUE;
        trUEHUE.col(1)=UE[1]*UUE;
        trUEHUE.col(2)=UE[2]*UUE;
        trUEHUE.col(3)=UE[3]*UUE;
        trUEHUE.col(4)=UE[4]*UUE;
        trUEHUE.col(5)=UE[5]*UUE;
		Matrix6 U;
