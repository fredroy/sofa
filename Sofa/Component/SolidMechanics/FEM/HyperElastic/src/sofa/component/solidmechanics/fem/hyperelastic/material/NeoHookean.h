...
public:
                          ...
                          const MaterialParameters<DataTypes>& param, Matrix6& outputTensor) override
    {
        ...
        Matrix6 trC_HC_;
        trC_HC_.col(0) = inverse_C[0] * CC;
        trC_HC_.col(1) = inverse_C[1] * CC;
        trC_HC_.col(2) = inverse_C[2] * CC;
        trC_HC_.col(3) = inverse_C[3] * CC;
        trC_HC_.col(4) = inverse_C[4] * CC;
        trC_HC_.col(5) = inverse_C[5] * CC;
