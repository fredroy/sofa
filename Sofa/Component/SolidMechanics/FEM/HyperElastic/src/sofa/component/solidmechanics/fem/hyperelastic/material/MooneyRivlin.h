...
public:
                         ...
                         const MaterialParameters<DataTypes>& param) override
    {
        ...
        return c1*(I1*pow(sinfo->J, (-2/3))-3)+c2*(I2*pow(sinfo->J, (-4/3)))+k0*log(sinfo->J)*
               log(sinfo->J)/2;
    }
                          ...
                          Matrix6& outputTensor) override
    {
        ...
        outputTensor = (((trC_HC_*I1/(Real)3.0-trID_HC_)/(Real)3.0+C_H_C*I1/(Real)3.0-trC_HID/(Real)
                         3.0)*(Real)2.0*c1*pow(sinfo->J, (Real)(-2.0/3.0))
                        +((trC_HC_*(Real)(-2.0)*I2/(Real)3.0+trID_HC_*I1-trCH_C)*(-2.0)/(Real)3.0+
                          C_H_C*(Real)2.0*I2/(Real)3.0-(trC_HID*I1-trC_HC)*(Real)2.0/(Real)3.0+
                          trIDHID-IDHID)*(Real)2.0*c2*pow(sinfo->J, (Real)(-4.0/3.0))
