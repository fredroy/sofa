...
bool BaseProximityIntersection::testIntersection(Cube& cube1, Cube& cube2, const core::collision::IntersectionParameters& params)
{
    ...
    const auto alarmDist = params.alarmDistance + cube1.getProximity() + cube2.getProximity();
...
int BaseProximityIntersection::computeIntersection(Cube& cube1, Cube& cube2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(cube1);
    SOFA_UNUSED(cube2);
