...
public:
    ...
    bool testIntersection(collision::geometry::Point&, collision::geometry::Point&, const core::collision::IntersectionParameters& params);
    template<class T> bool testIntersection(collision::geometry::TSphere<T>&, collision::geometry::Point&, const core::collision::IntersectionParameters& params);
    bool testIntersection(collision::geometry::Line&, collision::geometry::Point&, const core::collision::IntersectionParameters& params);
    template<class T> bool testIntersection(collision::geometry::Line&, collision::geometry::TSphere<T>&, const core::collision::IntersectionParameters& params);
    bool testIntersection(collision::geometry::Line&, collision::geometry::Line&, const core::collision::IntersectionParameters& params);
    bool testIntersection(collision::geometry::Triangle&, collision::geometry::Point&, const core::collision::IntersectionParameters& params);
    template<class T> bool testIntersection(collision::geometry::Triangle&, collision::geometry::TSphere<T>&, const core::collision::IntersectionParameters& params);

    int computeIntersection(collision::geometry::Point&, collision::geometry::Point&, OutputVector*, const core::collision::IntersectionParameters& params);
    template<class T> int computeIntersection(collision::geometry::TSphere<T>&, collision::geometry::Point&, OutputVector*, const core::collision::IntersectionParameters& params);
    int computeIntersection(collision::geometry::Line&, collision::geometry::Point&, OutputVector*, const core::collision::IntersectionParameters& params);
    template<class T> int computeIntersection(collision::geometry::Line&, collision::geometry::TSphere<T>&, OutputVector*, const core::collision::IntersectionParameters& params);
    int computeIntersection(collision::geometry::Line&, collision::geometry::Line&, OutputVector*, const core::collision::IntersectionParameters& params);
    int computeIntersection(collision::geometry::Triangle&, collision::geometry::Point&, OutputVector*, const core::collision::IntersectionParameters& params);
    template<class T> int computeIntersection(collision::geometry::Triangle&, collision::geometry::TSphere<T>&, OutputVector*, const core::collision::IntersectionParameters& params);
...
template <class T>
bool MeshMinProximityIntersection::testIntersection(collision::geometry::Triangle& e2, collision::geometry::TSphere<T>& e1, const core::collision::IntersectionParameters& params)
{
...
template <class T>
int MeshMinProximityIntersection::computeIntersection(collision::geometry::Triangle& e2, collision::geometry::TSphere<T>& e1, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.getProximity();
    ...
    const SReal contactDist = params.contactDistance + e1.r() + e1.getProximity() + e2.getProximity();
...
template <class T>
bool MeshMinProximityIntersection::testIntersection(collision::geometry::Line& e2, collision::geometry::TSphere<T>& e1, const core::collision::IntersectionParameters& params)
{
...
template <class T>
int MeshMinProximityIntersection::computeIntersection(collision::geometry::Line& e2, collision::geometry::TSphere<T>& e1, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    static_assert(std::is_same_v<collision::geometry::Line::Coord, typename collision::geometry::TSphere<T>::Coord>, "Data mismatch");
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.getProximity();
...
template <class T>
bool MeshMinProximityIntersection::testIntersection(collision::geometry::TSphere<T>& e1, collision::geometry::Point& e2, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.getProximity();
...
template <class T>
int MeshMinProximityIntersection::computeIntersection(collision::geometry::TSphere<T>& e1, collision::geometry::Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.getProximity();
...
{
    return testIntersection(e2, e1, {intersection->getAlarmDistance(), 0.0_sreal});
}
...
{
    return computeIntersection(e2, e1, contacts, {intersection->getAlarmDistance(), intersection->getContactDistance()});
}
...
{
    return testIntersection(e1, e2, {intersection->getAlarmDistance(), 0.0_sreal});
}
...
{
    return computeIntersection(e1, e2, contacts, {intersection->getAlarmDistance(), intersection->getContactDistance()});
}
