...
bool LocalMinDistance::testIntersection(Cube &cube1, Cube &cube2, const core::collision::IntersectionParameters& params)
{
    return Inherit1::testIntersection(cube1, cube2);
}

int LocalMinDistance::computeIntersection(Cube&, Cube&, OutputVector* /*contacts*/, const core::collision::IntersectionParameters& params)
{
    return 0; /// \todo
}

bool LocalMinDistance::testIntersection(Line& e1, Line& e2, const core::collision::IntersectionParameters& params)
{
    ...
    const SReal alarmDist = params.alarmDistance + e1.getProximity() + e2.getProximity();
...
int LocalMinDistance::computeIntersection(Line& e1, Line& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    ...
    const double contactDist = params.contactDistance + e1.getProximity() + e2.getProximity();
...
bool LocalMinDistance::testIntersection(Triangle& e2, Point& e1, const core::collision::IntersectionParameters& params)
{
...
int LocalMinDistance::computeIntersection(Triangle& e2, Point& e1, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    if(!e1.isActive(e2.getCollisionModel()))
        return 0;
...
bool LocalMinDistance::testIntersection(Triangle& e2, Sphere& e1, const core::collision::IntersectionParameters& params)
{
    if (!e1.isActive(e2.getCollisionModel()))
        return false;

    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.getProximity();
...
int LocalMinDistance::computeIntersection(Triangle& e2, Sphere& e1, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    if (!e1.isActive(e2.getCollisionModel()))
        return false;
    ...
    const double contactDist = params.contactDistance + e1.r() + e1.getProximity() + e2.getProximity();
...
bool LocalMinDistance::testIntersection(Line& e2, Point& e1, const core::collision::IntersectionParameters& params)
{
...
int LocalMinDistance::computeIntersection(Line& e2, Point& e1, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    static_assert(std::is_same_v<Line::Coord, Point::Coord>, "Data mismatch");
    using Real = Triangle::Coord::value_type;
...
bool LocalMinDistance::testIntersection(Line& e2, Sphere& e1, const core::collision::IntersectionParameters& params)
{
...
int LocalMinDistance::computeIntersection(Line& e2, Sphere& e1, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    static_assert(std::is_same_v<Line::Coord, Sphere::Coord>, "Data mismatch");
    using Real = Triangle::Coord::value_type;
...
bool LocalMinDistance::testIntersection(Point& e1, Point& e2, const core::collision::IntersectionParameters& params)
{
    if(!e1.isActive(e2.getCollisionModel()) || !e2.isActive(e1.getCollisionModel()))
        return false;
...
int LocalMinDistance::computeIntersection(Point& e1, Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    if(!e1.isActive(e2.getCollisionModel()) || !e2.isActive(e1.getCollisionModel()))
        return 0;
...
bool LocalMinDistance::testIntersection(Sphere& e1, Point& e2, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.getProximity();
...
int LocalMinDistance::computeIntersection(Sphere& e1, Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.getProximity();
    static_assert(std::is_same_v<Sphere::Coord, Point::Coord>, "Data mismatch");
...
bool LocalMinDistance::testIntersection(Sphere& e1, Sphere& e2, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.r() + e2.getProximity();
...
int LocalMinDistance::computeIntersection(Sphere& e1, Sphere& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.r() + e1.getProximity() + e2.r() + e2.getProximity();
    ...
    const double contactDist = params.contactDistance + e1.r() + e1.getProximity() + e2.r() + e2.getProximity();
...
bool LocalMinDistance::testIntersection(Ray &t1,Triangle &t2, const core::collision::IntersectionParameters& params)
{
    type::Vec3 P,Q;

    const SReal alarmDist = params.alarmDistance + t1.getProximity() + t2.getProximity();
...
int LocalMinDistance::computeIntersection(Ray &t1, Triangle &t2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + t1.getProximity() + t2.getProximity();
...
bool LocalMinDistance::testIntersection(Ray &ray1,Sphere &sph2, const core::collision::IntersectionParameters&)
{
...
int LocalMinDistance::computeIntersection(Ray &ray1, Sphere &sph2, OutputVector* contacts, const core::collision::IntersectionParameters&)
{
    // Center of the sphere
    const Vec3 sph2Pos(sph2.center());
    // Radius of the sphere
...
{
    return testIntersection(e1, e2, { getAlarmDistance(), 0.0_sreal});
}

int LocalMinDistance::computeIntersection(Line& e1, Line& e2, OutputVector* contacts)
{
    return computeIntersection(e1, e2, contacts, { getAlarmDistance(), getContactDistance()});
}

bool LocalMinDistance::testIntersection(Triangle& e2, Point& e1)
{
    return testIntersection(e2, e1, { getAlarmDistance(), 0.0_sreal});
}

int LocalMinDistance::computeIntersection(Triangle& e2, Point& e1, OutputVector* contacts)
{
    return computeIntersection(e2, e1, contacts, { getAlarmDistance(), getContactDistance()});
}
...
{
    return testIntersection(t1, t2, { getAlarmDistance(), 0.0_sreal});
}

int LocalMinDistance::computeIntersection(Ray &t1, Triangle &t2, OutputVector* contacts)
{
    return computeIntersection(t1, t2, contacts, { getAlarmDistance(), getContactDistance()});
}
