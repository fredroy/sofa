...
template<class T>
bool RayDiscreteIntersection::testIntersection(collision::geometry::Ray & ray1, collision::geometry::TSphere<T>& sph2, const core::collision::IntersectionParameters& params)
{
...
template<class T>
int RayDiscreteIntersection::computeIntersection(collision::geometry::Ray& ray1, collision::geometry::TSphere<T>& sph2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    // Center of the sphere
    const type::Vec3 sph2Pos(sph2.center());
    // Radius of the sphere
