...
bool MeshNewProximityIntersection::testIntersection(Point& pt1, Point& pt2, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(pt1);
    SOFA_UNUSED(pt2);
    SOFA_UNUSED(params);
...
bool MeshNewProximityIntersection::testIntersection(Line& line, Point& pt, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(line);
    SOFA_UNUSED(pt);
    SOFA_UNUSED(params);
...
bool MeshNewProximityIntersection::testIntersection(Line& line1, Line& line2, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(line1);
    SOFA_UNUSED(line2);
    SOFA_UNUSED(params);
...
bool MeshNewProximityIntersection::testIntersection(Triangle& tri, Point& pt, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(tri);
    SOFA_UNUSED(pt);
    SOFA_UNUSED(params);
...
bool MeshNewProximityIntersection::testIntersection(Triangle& tri, Line& line, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(tri);
    SOFA_UNUSED(line);
    SOFA_UNUSED(params);
...
bool MeshNewProximityIntersection::testIntersection(Triangle& tri1, Triangle& tri2, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(tri1);
    SOFA_UNUSED(tri2);
    SOFA_UNUSED(params);
...
int MeshNewProximityIntersection::computeIntersection(Point& e1, Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    ...
    if (n>0)
    {
        const SReal contactDist = params.contactDistance + e1.getProximity() + e2.getProximity();
...
int MeshNewProximityIntersection::computeIntersection(Line& e1, Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.getProximity() + e2.getProximity();
...
int MeshNewProximityIntersection::computeIntersection(Line& e1, Line& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.getProximity() + e2.getProximity();
...
int MeshNewProximityIntersection::computeIntersection(Triangle& e1, Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.getProximity() + e2.getProximity();
    const SReal dist2 = alarmDist*alarmDist;
...
int MeshNewProximityIntersection::computeIntersection(Triangle& e1, Line& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
...
int MeshNewProximityIntersection::computeIntersection(Triangle& e1, Triangle& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
