...
template <class T>
bool MeshNewProximityIntersection::testIntersection(collision::geometry::TSphere<T>& e1, collision::geometry::Point& e2, const core::collision::IntersectionParameters& params)
{
    OutputVector contacts;
    const double alarmDist = params.alarmDistance + e1.getProximity() + e2.getProximity() + e1.r();
    const int n = intersection->doIntersectionPointPoint(alarmDist * alarmDist, e1.center(), e2.p(), &contacts, -1);
    return n > 0;
}

template<class T>
int MeshNewProximityIntersection::computeIntersection(collision::geometry::TSphere<T>& e1, collision::geometry::Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.getProximity() + e2.getProximity() + e1.r();
    const int n = intersection->doIntersectionPointPoint(alarmDist*alarmDist, e1.center(), e2.p(), contacts, (e1.getCollisionModel()->getSize() > e2.getCollisionModel()->getSize()) ? e1.getIndex() : e2.getIndex());
    if (n>0)
    {
        const SReal contactDist = params.contactDistance + e1.getProximity() + e2.getProximity() + e1.r();
...
template <class T>
bool MeshNewProximityIntersection::testIntersection(collision::geometry::Line& e1, collision::geometry::TSphere<T>& e2, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(e1);
    SOFA_UNUSED(e2);
...
template<class T>
int MeshNewProximityIntersection::computeIntersection(collision::geometry::Line& e1, collision::geometry::TSphere<T>& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const SReal alarmDist = params.alarmDistance + e1.getProximity() + e2.getProximity() + e2.r();
    const int n = doIntersectionLinePoint(alarmDist*alarmDist, e1.p1(),e1.p2(), e2.center(), contacts, e2.getIndex());
    if (n>0)
    {
        const SReal contactDist = params.contactDistance + e1.getProximity() + e2.getProximity() + e2.r();
        for (OutputVector::iterator detection = contacts->end()-n; detection != contacts->end(); ++detection)
        {
            detection->elem = std::pair<core::CollisionElementIterator, core::CollisionElementIterator>(e1, e2);
            detection->value -= contactDist;
...
template <class T>
bool MeshNewProximityIntersection::testIntersection(collision::geometry::Triangle& e1, collision::geometry::TSphere<T>& e2, const core::collision::IntersectionParameters& params)
{
    SOFA_UNUSED(e1);
    SOFA_UNUSED(e2);
...
template<class T>
int MeshNewProximityIntersection::computeIntersection(collision::geometry::Triangle& e1, collision::geometry::TSphere<T>& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    ...
    detection->value -= (params.contactDistance + e1.getProximity() + e2.getProximity() + e2.r());
    detection->point[0]=p;
