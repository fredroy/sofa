...
bool TetrahedronDiscreteIntersection::testIntersection(Tetrahedron&, Point&, const core::collision::IntersectionParameters& params)
{
    return true;
}

int TetrahedronDiscreteIntersection::computeIntersection(Tetrahedron& e1, Point& e2, OutputVector* contacts, const core::collision::IntersectionParameters&)
{
    const Vec3 n = e2.n();
...
bool TetrahedronDiscreteIntersection::testIntersection(Ray&, Tetrahedron&, const core::collision::IntersectionParameters&)
{
    return true;
}

int TetrahedronDiscreteIntersection::computeIntersection(Ray& e1, Tetrahedron& e2, OutputVector* contacts, const core::collision::IntersectionParameters&)
{
