...
bool NewProximityIntersection::testIntersection(SphereType1& sph1, SphereType2& sph2, const core::collision::IntersectionParameters& params)
{
...
template<typename SphereType1, typename SphereType2>
int NewProximityIntersection::computeIntersection(SphereType1& sph1, SphereType2& sph2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
    const auto alarmDist = params.alarmDistance + sph1.getProximity() + sph2.getProximity();
