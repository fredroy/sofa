...
bool NewProximityIntersection::testIntersection(SphereType1& sph1, SphereType2& sph2, const core::collision::Intersection* currentIntersection)
{
    ...
    const int n = doIntersectionPointPoint(alarmDist2 * alarmDist2, sofa::type::toVec3(sph1.center()), sofa::type::toVec3(sph2.center()), &contacts, -1);
    return n > 0;
}
...
int NewProximityIntersection::computeIntersection(SphereType1& sph1, SphereType2& sph2, OutputVector* contacts, const core::collision::Intersection* currentIntersection)
{
    ...
    const double alarmDist2 = alarmDist + sph1.r() + sph2.r();
    const int n = doIntersectionPointPoint(alarmDist2 * alarmDist2, sofa::type::toVec3(sph1.center()), sofa::type::toVec3(sph2.center()), contacts, (sph1.getCollisionModel()->getSize() > sph2.getCollisionModel()->getSize()) ? sph1.getIndex() : sph2.getIndex());
    if (n > 0)
    {
