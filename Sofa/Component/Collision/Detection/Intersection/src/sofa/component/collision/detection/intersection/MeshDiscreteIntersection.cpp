...
bool MeshDiscreteIntersection::testIntersection(Triangle&, Line&, const core::collision::IntersectionParameters&)
{
    return true;
}

int MeshDiscreteIntersection::computeIntersection(Triangle& e1, Line& e2, OutputVector* contacts, const core::collision::IntersectionParameters& params)
{
