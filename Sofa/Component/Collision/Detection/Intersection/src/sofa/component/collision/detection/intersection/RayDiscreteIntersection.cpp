...
bool RayDiscreteIntersection::testIntersection(Ray&, Triangle&, const core::collision::IntersectionParameters&)
{
    return true;
}

int RayDiscreteIntersection::computeIntersection(Ray& e1, Triangle& e2, OutputVector* contacts, const core::collision::IntersectionParameters&)
{
    Vec3 A = e2.p1();
    Vec3 AB = e2.p2()-A;
    Vec3 AC = e2.p3()-A;
