...
public:
    ...
    {
        assert(intersector != nullptr);
        return intersector->canIntersect(elem2, elem1, params);
    }
    ...
    int intersect(core::CollisionElementIterator elem1, core::CollisionElementIterator elem2, core::collision::DetectionOutputVector* contacts, const core::collision::IntersectionParameters& params) override
    {
        assert(intersector != nullptr);
        return intersector->intersect(elem2, elem1, contacts, params);
    }
