...
template< typename DataTypes >
void TOglModel<DataTypes>::deleteTextures()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::deleteBuffers()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::parse(core::objectmodel::BaseObjectDescription* arg)
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::drawGroup(int ig, bool transparent)
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::drawGroups(bool transparent)
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::internalDraw(const core::visual::VisualParams* vparams, bool transparent)
{
...
template< typename DataTypes >
bool TOglModel<DataTypes>::hasTransparent()
{
    if(alphaBlend.getValue())
        return true;
...
template< typename DataTypes >
bool TOglModel<DataTypes>::hasTexture()
{
    return !textures.empty() || tex;
}

template< typename DataTypes >
bool TOglModel<DataTypes>::loadTexture(const std::string& filename)
{
...
template< typename DataTypes >
bool TOglModel<DataTypes>::loadTextures()
{
    bool result = true;
    textures.clear();
...
template< typename DataTypes >
void TOglModel<DataTypes>::initVisual()
{
    initTextures();
...
template< typename DataTypes >
void TOglModel<DataTypes>::initTextures()
{
    if (tex)
    {
        tex->init();
...
template< typename DataTypes >
void TOglModel<DataTypes>::createVertexBuffer()
{
    glGenBuffers(1, &vbo);
    initVertexBuffer();
    VBOGenDone = true;
...
template< typename DataTypes >
void TOglModel<DataTypes>::createEdgesIndicesBuffer()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::createTrianglesIndicesBuffer()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::createQuadsIndicesBuffer()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::initVertexBuffer()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::initEdgesIndicesBuffer()
{
    const Inherit::VecVisualEdge& edges = this->getEdges();
...
template< typename DataTypes >
void TOglModel<DataTypes>::initTrianglesIndicesBuffer()
{
    const Inherit::VecVisualTriangle& triangles = this->getTriangles();
...
template< typename DataTypes >
void TOglModel<DataTypes>::initQuadsIndicesBuffer()
{
    const Inherit::VecVisualQuad& quads = this->getQuads();
...
template< typename DataTypes >
void TOglModel<DataTypes>::updateVertexBuffer()
{
    ...
    if constexpr (!std::is_same_v<Coord::value_type, float>)
    {
    ...
    {
        positionBuffer = &vertices[0];
        normalBuffer = &vnormals[0];
    }
...
template< typename DataTypes >
void TOglModel<DataTypes>::updateEdgesIndicesBuffer()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::updateTrianglesIndicesBuffer()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::updateQuadsIndicesBuffer()
{
...
template< typename DataTypes >
void TOglModel<DataTypes>::updateBuffers()
{
    const Inherit::VecVisualEdge& edges = this->getEdges();
    const Inherit::VecVisualTriangle& triangles = this->getTriangles();
    const Inherit::VecVisualQuad& quads = this->getQuads();
...
template< typename DataTypes >
GLenum TOglModel<DataTypes>::getGLenum(const char* c ) const
{
