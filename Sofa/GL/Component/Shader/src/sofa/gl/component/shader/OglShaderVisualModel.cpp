...
void OglShaderVisualModel::computeRestPositions()
{
    ...
    {
        vrestpos[i] = restpositions[i].cast<float>();
    }
...
void OglShaderVisualModel::computeRestNormals()
{
    ...
    for (unsigned int i = 0; i < quads.size() ; i++)
    {
        ...
        auto n1 = type::cross(v2-v1, v4-v1);
        auto n2 = type::cross(v3-v2, v1-v2);
        auto n3 = type::cross(v4-v3, v2-v3);
        auto n4 = type::cross(v1-v4, v3-v4);
