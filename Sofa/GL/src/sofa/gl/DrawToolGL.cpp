...
void DrawToolGL::drawFrame(const Vec3& position, const Quaternion &orientation, const Vec<3,float> &size)
{
    ...
    gl::Axis::draw(position, orientation, size.cast<SReal>(), type::RGBAColor::red(), type::RGBAColor::green(), type::RGBAColor::blue());
}
...
{
    setPolygonMode(0,false);
    gl::Axis::draw(position, orientation, size.cast<SReal>(), color, color, color);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
