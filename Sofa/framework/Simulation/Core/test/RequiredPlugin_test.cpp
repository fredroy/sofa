...
struct RequiredPlugin_test : public BaseSimulationTest
{
    ...
    {
        EXPECT_MSG_NOEMIT(Warning); // // TestPluginB registers its component explicitly
...
TEST_F(RequiredPlugin_test, DISABLED_testLoadPluginA) { testLoadPluginA(); } // disabled because testLoadPluginA() should throw a warning (which it commented in the code)
