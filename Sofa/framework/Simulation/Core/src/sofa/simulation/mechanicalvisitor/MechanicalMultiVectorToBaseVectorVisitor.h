...
class SOFA_SIMULATION_CORE_API SOFA_ATTRIBUTE_DEPRECATED__MECHANICALMULTIVECTORTOBASEVECTORVISITOR() MechanicalMultiVectorToBaseVectorVisitor : public BaseMechanicalVisitor
{
public:
