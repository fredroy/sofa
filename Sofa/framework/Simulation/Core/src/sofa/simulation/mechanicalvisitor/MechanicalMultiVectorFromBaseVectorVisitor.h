...
class SOFA_SIMULATION_CORE_API SOFA_ATTRIBUTE_DEPRECATED__MECHANICALMULTIVECTORFROMBASEVECTORVISITOR() MechanicalMultiVectorFromBaseVectorVisitor : public BaseMechanicalVisitor
{
public:
