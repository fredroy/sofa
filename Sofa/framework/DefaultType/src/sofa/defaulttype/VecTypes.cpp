...
******************************************************************************/
#define SOFA_DEFAULTTYPE_VECTYPES_CPP
...
template class SOFA_DEFAULTTYPE_API CompressedRowSparseMatrixGeneric<type::Vec1d>;
template class SOFA_DEFAULTTYPE_API CompressedRowSparseMatrixGeneric<type::Vec2d>;
template class SOFA_DEFAULTTYPE_API CompressedRowSparseMatrixGeneric<type::Vec3d>;
template class SOFA_DEFAULTTYPE_API CompressedRowSparseMatrixGeneric<type::Vec6d>;
